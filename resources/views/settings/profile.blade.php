                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_name"
                                                value="{{ old('first_name', $user->last_name) }}" id="last_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company"
                                                value="{{ old('first_name', $user->company) }}" id="company"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="bio">Bio</label>
                                            <textarea name="bio" id="biod" rows="3" class="form-control"> {{ old('first_name', $user->bio) }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new img-thumbnail"
                                                    ...
                                                    <img src="{{ $user->profile_picture ? asset('uploads/'. $user->profile_picture) : 'http://via.placeholder.com/150x150' }}" alt="...">
                                                </div>
